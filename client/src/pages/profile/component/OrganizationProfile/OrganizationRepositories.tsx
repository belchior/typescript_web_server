import { useOrganizationRepositories, type ProfileOwner } from '../../../../network/httpServer'
...
export function OrganizationRepositories(props: OrganizationRepositoriesProps) {
  const { profile } = props
  const { data: repositories, loadNext } = useOrganizationRepositories(profile.login, { first: 2 })

INSERT INTO users (login, name, email, url, avatar_url, bio, website_url, location) VALUES
  ('belchior', 'Belchior Oliveira', 'belchior@email.com', 'https://github.com/belchior', 'https://avatars3.githubusercontent.com/u/2656585?u=de302ff93b129cf3841471deb188a5f5e51a2417&v=4', 'Software engineer', 'https://twitter.com/belchiorso', 'Brasil'),
  ('foo', 'Foo', 'foo@email.com', 'https://github.com/foo', 'https://foo.com/avatar.jpg', null, null, null),
...
INSERT INTO organizations (login, url, name, description, avatar_url) VALUES
  ('belchior-org', 'https://github.com/belchior-org', 'My Org', 'Test Org', 'https://avatars3.githubusercontent.com/u/2656585?u=de302ff93b129cf3841471deb188a5f5e51a2417&v=4'),
